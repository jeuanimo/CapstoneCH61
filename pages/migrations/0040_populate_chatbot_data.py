# Generated by Django 4.2.28 on 2026-03-11 15:23
...
def populate_chatbot_qa(apps, schema_editor):
    ...
    qa_entries = [
        ...
        },
        {
            ...
            'answer': 'Community members and friends are often welcome at our chapter events. Please check our Events page for upcoming activities or contact us to inquire about specific events you\'d like to attend.',
            'category': 'events',
            'is_active': True,
            'confidence_threshold': 30
        },
        ...
        },
        {
            ...
            'keywords': 'college university affiliated campus',
...
def reverse_populate(apps, schema_editor):
    """Optional: remove the data on reverse migration."""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("pages", "0039_add_event_tickets"),
    ]

    operations = [
        migrations.RunPython(populate_chatbot_qa, reverse_populate),
    ]
